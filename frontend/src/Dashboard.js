...
import { fetchConfig, configHydration } from "./helpers";
      ...
      <Box sx={{ display: "flex" }}>
        <AppBar position="absolute" open={open}>
          ...
          >
            ...
            <img src="logo32.png" style={{height:"24px",paddingRight:"5px"}} />
            <Typography
              component="h1"
              variant="h6"
              color="primary.light"
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
                ...
                >
                  <Pie
                    data={MassagePieData(
                      decideData(cm, secret, sa, resource, namespace)
                    )}
                  />
                </Paper>
              </Grid>
              ...
              <Grid item xs={12}>
                <Paper sx={{ p: 2, display: "flex", flexDirection: "column" }}>
                  <TableResources
                    data={decideData(cm, secret, sa, resource, namespace)}
                  />
                </Paper>
              </Grid>
            </Grid>
